...
class LL4GLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core 
{
  ...
  protected:
    ...
    virtual void modelTransformEspelma ();
    virtual void viewTransform ();
    virtual void projectTransform ();

    void creaBuffersMorty ();	
    void creaBuffersEscenari ();
    void creaBuffersEspelma ();
    void creaBuffersTerra ();
    void carregaShaders ();

    void calculaCapsaModelMorty ();
    void calculaCapsaModelEscenari ();
    void calculaCapsaModelEspelma ();
    ...
    glm::vec3 centreBaseEscenari;
    glm::vec3 centreBaseEspelma;
    float escalaMorty, escalaEscenari, escalaEspelma;
