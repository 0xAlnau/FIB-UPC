...
void MyGLWidget::initializeGL ()
{
  ...
  calculCentreRadi(glm::vec3(-2.0f, -1.0f, -2.0f), glm::vec3(2.0f, 2.0f, 2.0f)); //important fer-ho abans!
...
void MyGLWidget::viewTransform() { //VM
    ...
    glm::mat4 View = glm::lookAt(centre + d*glm::vec3(0.0f, 0.0f, 1.0f), centre, glm::vec3(0.0f, 1.0f, 0.0f)); //el vector de obs ha de tenir llargada 1!!!!!!!!
