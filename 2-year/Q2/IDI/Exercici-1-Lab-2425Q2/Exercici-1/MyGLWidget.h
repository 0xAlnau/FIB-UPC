...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core
{
  ...
  private:
    ...
    void modelTransformCistella(float angle);
    ...
    // uniforms
    GLuint TGLoc;
    GLuint num_referencia; //tindrà valors 1 (sector), 2 (base) o 3 (cistella)
    ...
    float angleCistellaNoria = 90.f/2.f;
    float angleGirar = 0.0;
    float VuitCistelles = 0.0;
};
