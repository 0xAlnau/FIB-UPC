...
void Multitex::onPluginLoad()
{
	...
	// Load Texture 1
	QString filename = QFileDialog::getOpenFileName(0, "Open Image", "/assig/grau-g/Textures", "checkerboard.png");	
	...
	// Load Texture 2
	QString filename2 = QFileDialog::getOpenFileName(0, "Open Image 2", "/assig/grau-g/Textures", "bill-gates.jpg");	
