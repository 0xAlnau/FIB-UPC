...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSTextureSplattingENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSTextureSplattingENDCLASS_t qt_meta_stringdata_CLASSTextureSplattingENDCLASS = {
    {
        QT_MOC_LITERAL(0, 16)   // "TextureSplatting"
    },
    "TextureSplatting"
};
