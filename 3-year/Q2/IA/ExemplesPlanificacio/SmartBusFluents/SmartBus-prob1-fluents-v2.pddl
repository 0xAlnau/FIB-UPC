(define (problem SmartBus-1bus-14paradas-21usuarios)
   ...
   (:objects Sbus027 - SBus
	     ...
	     Esteban Cristina Daniel Luis Lorena Jesus Raul Maria Estela 
	         Martina Noelia Pau Jordi Susana Beatriz Ruth 
	     Sebas Xavier Alba Kilian Fabiola - persona
    )

  (:init
    (= (butacasLibres Sbus027) 12)
    (= (plazasMrLibres Sbus027) 2)
    (movilidadReducida Sebas)
    (movilidadReducida Xavier)
    (movilidadReducida Alba)
    (movilidadReducida Kilian)
    (movilidadReducida Fabiola)
