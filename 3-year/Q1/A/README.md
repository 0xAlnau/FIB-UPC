...
| --- | ---- | ------- | -----------| --------------- |
| Algorismia | A | 6 |    10/10    |       8/10      | 

## Petita Descripció:
Aquesta és una assignatura estrella de l'especialitat en Computació. Hi ha quatre blocs ben diferenciats: algorismes bàsics, com QuickSelect o ordenacions lineals; algorismes greedy; programació dinàmica; fluxos. Durant el curs s'han d'anar fent problemes entregables i un projecte de quatre persones sobre un tema que escogeix un professor (grande Santiago Marco amb el Patricia Trie). 
