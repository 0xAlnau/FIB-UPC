...
public:
  ...
  class iterator {
    ...
    private:
      ...
      Item *pitem;
      bool enllas;
      iterator* quantum_iterator;
    public:
      
    iterator() {
      enllas = false;
      quantum_iterator = NULL;
    }
       ...
       el resultat és el p.i. */
    {
      ...
      if (enllas) {
        if ((*quantum_iterator).pitem == &((*quantum_iterator).plist->itemsup)) {}
        else (*quantum_iterator).pitem = (*quantum_iterator).pitem->next;
      }
      return *this;
    }
       ...
       el resultat és el p.i. */
    {
      ...
      if (enllas) {
        if ((*quantum_iterator).pitem == (*quantum_iterator).plist->iteminf.next) {}
        else (*quantum_iterator).pitem = (*quantum_iterator).pitem->prev;
      }
      return *this;
    }
